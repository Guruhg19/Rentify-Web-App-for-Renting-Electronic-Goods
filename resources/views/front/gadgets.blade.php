...
<body>
	<main class="max-w-[640px] mx-auto min-h-screen flex flex-col relative has-[#Bottom-nav]:pb-[144px]">
		...
		<section id="brand"
			class="flex p-[24px_20px] outline  outline-[#EDEEF0] rounded-2xl overflow-hidden items-center justify-between mt-[30px] mx-5">
		...
		<section id="Explore" class="flex flex-col gap-[10px] mx-5 mt-[30px]">
			...
			<div class="flex flex-col gap-5">
                ...
                @empty
                    <p>Belum ada produk dari brand dan kategori ini.</p>
                @endforelse
